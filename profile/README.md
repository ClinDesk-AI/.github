...
Private AI clinic workspace for WhatsApp-first practices. Runs on the doctor's own Mac.

ClinDesk helps clinics handle patient messages with context. It keeps patient details and conversation history close at hand, prepares replies in the clinic's voice, and only wakes the doctor when a patient really needs personal attention.
